...
1. Subir um ambiente LocalStack com suporte ao SQS via Docker Compose.
2. Criar automaticamente uma fila SQS durante a inicialização.
3. Utilizar uma aplicação em **Go** para interagir com essa fila:
